...
/// <summary>
/// Pedido formal realizado por um cliente interessado na locação de um contêiner. 
/// A solicitação pode incluir informações sobre finalidade, localização, quantidade 
/// e período desejado. <see href="https://wiki.containrs.com/glossario"/>
/// </summary>
